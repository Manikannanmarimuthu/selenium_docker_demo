...
public class BillingOrganizationTest extends AbstractTest {
	...
	public void enterReviewerCommentsAndSubmit() {
		ReviewBillingOrganizationPage revBillOrgPage = new ReviewBillingOrganizationPage(driver);
		revBillOrgPage.enterRevCommentsAndclickApproveBtn(testData.ReviewerComments());
