...
public abstract class ORReviewBillingOrganizationSummaryPage extends AbstractPage {

	public ORReviewBillingOrganizationSummaryPage(WebDriver driver) {
		super(driver);
	}

//  Review Billing Organization Summary Details

	@FindBy(css = "#msg")
	protected WebElement getTextSuccessMessage;
