...
public abstract class ORBillingOrganizationHistoryPage extends AbstractPage {

	public ORBillingOrganizationHistoryPage(WebDriver driver) {
		super(driver);
	}

//  Billing Organization History Details
