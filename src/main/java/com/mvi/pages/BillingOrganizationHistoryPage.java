...
import com.mvi.objectrepository.ORBillingOrganizationHistoryPage;
import com.mvi.utils.DateUtils;

public class BillingOrganizationHistoryPage extends ORBillingOrganizationHistoryPage {

	public BillingOrganizationHistoryPage(WebDriver driver) {
		super(driver);
	}
	...
	public void billingOrganizationHistoryBtn() {
		click(WaitStrategy.VISIBLE, this.btnBillOrgHistory);
	}

	public boolean verifyBillingOrgHistoryPageOne(String custRefFormat1, String custRefFormat2, String custRefDesc) {
	...
	public boolean verifyBillingOrgHistoryPageTwo(String billDesc, String uen, String accountName, String accountNo) {
	...
	public boolean verifyBillingOrgHistoryPageThree(String creditorBankCode, String status, String billingPurpose) {
		List<Boolean> verifyBillingOrgHistoryPageTwo = new ArrayList<>();
		verifyBillingOrgHistoryPageTwo
